...
void setup() {
  ...
  //
  pt1X = pt5X = pt9X = pt13X = displayWidth*0;
  pt2X = pt6X = pt10X = pt14X = displayWidth*1/3;
  pt3X = pt7X = pt11X = pt15X = displayWidth*2/3;
  pt4X = pt8X = pt12X = pt16X = displayWidth*3/3;
  //
  ...
  button3Y = displayHeight * 14/16; //Section 3, subsection 4: denominator is 3*5, numerator is counted
  button3Width = displayWidth * 1/3 * 1/5;
  button3Height = displayHeight * 1/3 * 1/5;
